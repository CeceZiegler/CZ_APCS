public class LorumIpsumStringMethods
{
    public static void main(String[] args)
    {
      ...
      /*In this method, I have created a string variable that is a paragraph of text. I then used the methods with
      the string type to figure out different things about the paragraph, and change it to uppercase and lowercase.*/
       
      System.out.println("The text is" + " " + text.length() + " " + "characters long.");
      System.out.println("The new text is" + " " + newText.length()+ " " + "characters long");
      System.out.println(newText.toUpperCase());
      System.out.println(newText.toLowerCase());
      System.out.println(newText.equals("goat"));
      System.out.println(newText.equals(text));
      System.out.println(newText.equals(newText));
      System.out.println(newText.indexOf("q"));
      System.out.println(newText.indexOf("nullam"));
      System.out.println(newText.replaceAll("o", "x"));
      System.out.println(newText.contains("z"));
